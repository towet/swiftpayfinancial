...
import MiniAppAnalytics from "./pages/MiniAppAnalytics";
import MiniAppOrders from "./pages/MiniAppOrders";
  ...
  return (
    <>
      <Routes>
        ...
        <Route path="/dashboard/mini-apps/:id/analytics" element={<ProtectedRoute element={<MiniAppAnalytics />} />} />
        <Route path="/dashboard/mini-apps/:id/orders" element={<ProtectedRoute element={<MiniAppOrders />} />} />
        ...
        <Route path="/dashboard/wallet" element={<ProtectedRoute element={<DashboardWallet />} />} />
